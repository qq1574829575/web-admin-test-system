  ...
  >
    <el-scrollbar style="height: 60vh;margin-top: -30px;" :wrap-style="[{ 'overflow-x': 'hidden'}]">
      <el-form ref="form" :rules="rules" :model="form" label-width="120px" label-position="left">
        ...
        <el-form-item label="路由标题(中文)" prop="title">
          <el-input v-model="form.title" placeholder="路由标题" />
        </el-form-item>
        ...
        <el-form-item label="路由图标">
          <el-input v-model="form.icon" placeholder="Icon图标类名" />
        </el-form-item>
  ...
  methods: {
    onOpen() {
      if (this.fatherRoute) {
        ...
        this.form.isRootRoute = this.fatherRoute.id === 0
      }
    },
    onClose() {
